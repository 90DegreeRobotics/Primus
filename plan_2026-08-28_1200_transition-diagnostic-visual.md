...
- [x] Compile/run focused chart and contract tests; audit and explicitly commit/push only owned source/test/ignore/plan paths before generating the diagnostic. The focused BridgeData suite passed 70 tests.
